  ...
  return (
    <div>
      ...
      <div className="min-h-screen flex flex-col justify-start items-start px-10 overflow-auto md:pt-5 pt-5 md:mb-10 pb-20">
        ...
        <p>Once a booking is made, it can be cancelled and non-refundable</p>

        <h3 className="mb-2 mt-2">
          <strong>Refund policy</strong>
        </h3>
        <p>
          In the event that a customer fails to attend the saloon or parlour,
          they will not be eligible for a refund. However, if the owner fails to
          provide the service, a refund will be issued within 3 working days.
        </p>
